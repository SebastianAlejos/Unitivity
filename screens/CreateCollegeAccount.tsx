...
export default function CreateCollegeAccount(props: CompProps) {
  return (
    <ImageBackground source={require("../assets/images/splash_1.png")} resizeMode="cover" style={styles.image}>
      <View style={styles.container}>
        <View style={[styles.box, styles.shadowProp]}>
          <Text style={styles.title}>Unitivity - Create a College Account</Text>
          <TextInput
          ...
          placeholderTextColor="#000" 
          style={styles.input}
          placeholder="Administrative email for college"
          />
          <TextInput
          secureTextEntry={true}
          placeholderTextColor="#000" 
