...
export default function CreatePassword(props: CompProps) {
  return (
    <ImageBackground source={require("../assets/images/splash_1.png")} resizeMode="cover" style={styles.image}>
      <View style={styles.container}>
        <View style={[styles.box, styles.shadowProp]}>
          ...
          />
          <Pressable style={styles.button} onPress={()=>{ alert('You have created your password successfully. Please log in'); props.navigation.navigate('Login') }}>
