import { StyleSheet, Text, View, ScrollView, Animated, Platform, useWindowDimensions, StatusBar, PanResponderGestureState, NativeSyntheticEvent, NativeScrollEvent, TouchableOpacity} from "react-native";
...

            {
              eventList.map((event, i) => (
                <ListItem
                  ...
                  bottomDivider
                >
                  <TouchableOpacity style={{ flex: 1 }} onPress={() => { props.navigation.navigate('Event_Details') }}>
