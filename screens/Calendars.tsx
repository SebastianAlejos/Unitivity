...
import { StyleSheet, View, Text, Platform, ImageBackground, ScrollView } from 'react-native';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import CalendarStrip from 'react-native-slideable-calendar-strip';
import { Header, ListItem, Button } from '@react-native-elements/base';
  ...
  return (
    <ImageBackground source={require("../assets/images/splash_2.png")} resizeMode="cover" style={styles.image}>
      ...
      <Button
        ...
        onPress={()=>{ props.navigation.navigate('CreateEvent_1')}}
      />
    </ImageBackground>
  )
};
